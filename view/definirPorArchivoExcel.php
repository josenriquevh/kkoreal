...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Archivo Horario Personal</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="form" action="../controller/definirPorArchivoExcelAction.php" method="post" enctype="multipart/form-data">
