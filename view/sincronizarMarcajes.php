...
$datosMarcaje = $consulta->Conectar("access","SELECT Checkinout.Logid, Checkinout.Userid, Checkinout.CheckTime, Checkinout.CheckType FROM Checkinout WHERE Checkinout.Logid > ".$ultimoMarcaje[0]['logid']." ORDER BY Checkinout.CheckTime ASC");
